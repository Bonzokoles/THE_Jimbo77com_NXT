            ...
            <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-8 md:gap-0">
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  />
                  <div>
                    <p className="text-foreground text-lg font-bold tracking-tight uppercase italic">
                      {current.author}
                    </p>
              ...
              <div className="flex items-center gap-4">
                <motion.button
                  ...
                  onClick={goPrev}
                >
                  <motion.div className="bg-primary absolute inset-0 opacity-0 group-hover:opacity-10 transition-opacity" />
                  <svg
                    width="20"
                    height="20"
                    viewBox="0 0 16 16"
