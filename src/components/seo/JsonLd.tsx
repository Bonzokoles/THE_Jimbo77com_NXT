    ...
    '@graph': [
      {
        ...
        description:
          'Architekt systemów AI i automatyzacji. Edge Computing, Multi-Agent Systems, projektowanie 3D i nowoczesny web development.',
        ...
        sameAs: ['https://github.com/Bonzokoles', 'https://github.com/77Jimbo77'],
        worksFor: {
          '@type': 'Organization',
          name: 'JIMBO Inc',
          url: 'https://jimbo77.com',
      ...
      },
      {
        ...
        description:
          'Portfolio Full Stack Developera i Inżyniera AI. Projekty, doświadczenie, umiejętności.',
      ...
      },
      {
        ...
        description:
          'Full Stack Development, systemy AI, automatyzacja procesów, projektowanie 3D, Cloudflare Workers. Dostępny zdalnie i lokalnie w Polsce.',
        url: 'https://jimbo77.com',
        image: 'https://jimbo77.com/about/apple-touch-icon.png',
        priceRange: '$$',
        address: {
