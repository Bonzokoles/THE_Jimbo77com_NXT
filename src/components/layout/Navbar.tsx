...
function Clock() {
  ...
  if (!mounted)
    return <span className="font-mono text-xl md:text-2xl font-black opacity-0">00:00:00</span>;
        ...
        <div className="container-creative py-4 md:py-6">
          ...
          >
            ...
            <div className="hidden lg:flex items-center gap-6">
              ...
              <CardNav items={navItems} theme={isDark ? 'dark' : 'light'} pathname={pathname} />
            ...
            <div className="relative flex flex-col items-center justify-center h-full overflow-y-auto py-20">
              <nav className="flex flex-col items-center gap-6">
                ...
                {navItems.map((category) => (
                  <div
                    key={category.label}
                    className="flex flex-col items-center gap-4 py-4 border-b border-white/5 w-full last:border-0 text-center"
                  >
              ...
              >
                ...
                {mounted && (
                  <AnimatedThemeToggler className="px-6 py-6 glass-card text-sm font-medium hover:bg-muted/50 flex items-center gap-2" />
                )}
              </motion.div>
            </div>
          </motion.div>
