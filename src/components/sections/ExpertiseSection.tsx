...
export default function ExpertiseSection() {
  ...
  const galleryItems = [
    ...
    },
    {
      ...
      text: 'Web3 i Blockchain',
    },
    {
      image: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=800&h=600&fit=crop',
      text: 'Chmura Obliczeniowa',
    },
    {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative py-20 md:py-32 overflow-hidden bg-gradient-to-b from-background via-muted to-background dark:bg-none dark:bg-black"
    >
      {/* Animated Background */}
      ...
      <div className="container-creative relative z-10 px-6">
        ...
        >
          ...
          <div className="mb-12 w-full overflow-hidden">
            <TextScrollMarquee
              baseVelocity={-2}
              className="text-3xl md:text-7xl lg:text-8xl font-black tracking-tight"
            >
