  ...
  return (
    ...
    >
      <div className="grid lg:grid-cols-2 gap-8 items-start">
        <div className="space-y-6">
          ...
          <p className="text-muted-foreground leading-relaxed max-w-md">
            Kierunek {education.major}, średnia {education.gpa}. Specjalizacja w Inżynierii AI i
            Badaniach Systemowych. Aktywny udział w laboratoriach badawczych i ogólnopolskich
            konkursach.
          </p>
        </div>
      ...
      >
        ...
        <motion.div animate={{ rotate: showTimeline ? 180 : 0 }} transition={{ duration: 0.3 }}>
            ...
            <div className="space-y-4 pt-4 border-t border-border">
              {portfolioData.education.map((edu: Education, index: number) => (
                ...
                >
                  ...
                  {edu.gpa && <span className="text-sm font-semibold text-primary">{edu.gpa}</span>}
                </motion.div>
              ))}
            </div>
          </motion.div>
                  ...
                  >
                    ...
                    <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-2 mb-2">
                      ...
                      <span className="text-xs font-mono text-muted-foreground bg-secondary/50 px-2 py-1 rounded whitespace-nowrap">
                        ...
                        {exp.endDate ? formatDate(exp.endDate) : 'Obecnie'}
                      </span>
                    </div>
  ...
  return (
    ...
    >
      ...
      <p className="text-muted-foreground max-w-md">
        Szczegółowy przegląd doświadczeń z wyróżnieniami projektów i osiągnięć będzie dostępny
        wkrótce.
      </p>
    </motion.div>
  );
    ...
    <div className="py-16 space-y-12">
      ...
      >
        ...
        <p className="text-center text-muted-foreground mt-2 max-w-md mx-auto">
          {activeTab === 'education' &&
            'Budowanie silnych fundamentów poprzez doskonałość akademicką'}
