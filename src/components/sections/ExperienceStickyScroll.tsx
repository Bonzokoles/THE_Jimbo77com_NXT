  ...
  const journeyContent = [
    {
      ...
      title: 'JIMBO Inc',
      description:
        'Budowa ekosystemu AI Workers na mybonzo.com — 30+ Cloudflare Workers, systemy Multi-Agent (MOA), RAG z ChromaDB, serverless architecture na Edge Computing. Orkiestracja agentów AI z intelligent routing.',
      content: (
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <div className="flex flex-wrap gap-2 justify-center mb-4">
              {['CEO', 'Architekt AI', '30+ Workers'].map((s) => (
                <span
                  key={s}
                  className="px-3 py-1 rounded-full text-[10px] bg-primary/10 text-primary border border-primary/20 font-mono font-bold backdrop-blur-md"
                >
                  {s}
                </span>
              ))}
    ...
    },
    {
      ...
      description:
        'PRO100 — projektowanie mebli z automatyzacjami AI. SketchUp — modele 3D konstrukcji drewnianych. Blender & TwinMotion — photorealistic renders i wizualizacje przestrzenne. Photoshop & Lightroom — obróbka graficzna i postprodukcja. Liceum plastyczne + Akademia Sztuk Użytkowych jako fundament.',
      content: (
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <div className="flex flex-wrap gap-2 justify-center mb-4">
              {['PRO100', 'Blender', 'Photoshop', '3D Design'].map((s) => (
                <span
                  key={s}
                  className="px-3 py-1 rounded-full text-[10px] bg-orange-500/10 text-orange-600 dark:text-orange-400 border border-orange-500/20 font-mono font-bold backdrop-blur-md"
                >
                  {s}
                </span>
              ))}
