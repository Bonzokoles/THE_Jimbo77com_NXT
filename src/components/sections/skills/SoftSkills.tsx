      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <div className="space-y-4">
            ...
            <h2 className="text-4xl md:text-7xl font-black italic uppercase tracking-tighter leading-[0.9]">
              Strategiczne
              <br />
              <span className="text-neutral-700 dark:text-muted-foreground font-light not-italic">
                Dyrektywy
              </span>
            </h2>
          </div>
          ...
          >
            Kompetencje interpersonalne zaprojektowane z myślą o przywództwie i systemowym
            rozwiązywaniu problemów w złożonych środowiskach.
          </motion.p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {pairs.map((pair, idx) => (
            ...
            >
              <FlippingCard front={pair.front} back={pair.back} index={idx} />
            </motion.div>
          ))}
        </div>
      </div>
