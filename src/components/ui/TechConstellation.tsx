      ...
      {nodes.map((node, i) => (
        ...
        >
          <div className="relative">
            ...
            <motion.span className="absolute top-full left-1/2 -translate-x-1/2 mt-4 px-2 py-1 rounded bg-black/80 text-[8px] font-black uppercase tracking-widest pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap border border-white/10">
              {node.name}
            </motion.span>
          </div>
        </motion.div>
