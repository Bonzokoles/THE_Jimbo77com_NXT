...
export function LogoTimeline({
  ...
  return (
    <div className={cn('relative', className)}>
      ...
      <div className={cn('relative overflow-hidden mx-4 sm:mx-8 md:mx-16 lg:mx-24', height)}>
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(to right, hsl(var(--background)) 0%, hsl(var(--background) / 0.95) 40%, hsl(var(--background) / 0.6) 70%, transparent 100%)',
          }}
        />
        <div
          ...
          style={{
            background:
              'linear-gradient(to left, hsl(var(--background)) 0%, hsl(var(--background) / 0.95) 40%, hsl(var(--background) / 0.6) 70%, transparent 100%)',
          }}
        />
          ...
          {rows.map((rowItems, rowIndex) => {
            ...
            return (
              <div key={rowIndex} className="relative w-full h-8 sm:h-10">
                ...
                <div className="absolute top-1/2 left-0 right-0 -translate-y-1/2 h-px z-0 dotted-track" />
                  ...
                  return (
                    ...
                    >
                      <Icon
                        ...
                        className="text-foreground/70 flex-shrink-0 w-3 h-3 sm:w-4 sm:h-4"
                      />
