...
export const MonolithStack = ({ tools, className }: MonolithStackProps) => {
  ...
  return (
    <div
      ref={containerRef}
      className={`relative min-h-[200vh] py-64 flex flex-col items-center ${className}`}
    >
      ...
      <div className="relative z-10 text-center mb-64 px-6">
        <span className="text-[10px] font-black uppercase tracking-[1.5em] text-white/20">
          Monolith_Protocol
        </span>
      ...
      <div className="flex h-full items-center px-12 md:px-24 gap-12 md:gap-24 relative z-10">
        ...
        <div className="flex flex-col justify-center gap-4">
          <span className="text-[10px] font-mono text-white/20 tracking-[0.5em] uppercase">
            Core_Artifact // {index.toString().padStart(2, '0')}
          </span>
