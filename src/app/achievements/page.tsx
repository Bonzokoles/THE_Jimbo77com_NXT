  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`relative h-28 w-full overflow-hidden bg-gradient-to-br ${config.gradient}`}
        >
          <motion.div
          ...
          <div className="mb-6">
            ...
            <p className="text-foreground/80 leading-relaxed">
              {achievement.description ||
                'To osiągnięcie stanowi ważny kamień milowy w mojej drodze zawodowej, demonstrując zaangażowanie, ekspertyzę i dążenie do doskonałości.'}
            </p>
          </div>
...
export default function AchievementsPage() {
  ...
  const stats = useMemo(() => {
    ...
    const awards = portfolioData.achievements.filter(
      (a) => a.category.toLowerCase() === 'award'
    ).length;
    const certifications = portfolioData.achievements.filter(
      (a) => a.category.toLowerCase() === 'certification'
    ).length;
    const competitions = portfolioData.achievements.filter(
      (a) => a.category.toLowerCase() === 'competition'
    ).length;
  ...
  const getCategoryCount = (cat: string) => {
    ...
    return portfolioData.achievements.filter((a) => a.category.toLowerCase() === cat.toLowerCase())
      .length;
  };
      ...
      <div className="relative z-50 bg-background shadow-[0_-20px_40px_rgba(0,0,0,0.2)]">
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="lg:w-2/5 xl:w-1/3 h-auto lg:h-screen lg:sticky lg:top-0 flex flex-col pt-28 lg:pt-36">
            ...
            >
              ...
              <motion.div variants={staggerItem}>
                <NavItem
                  label="Certyfikaty"
                  active={activeCategory === 'certification'}
              ...
              <motion.div variants={staggerItem}>
                <NavItem
                  label="Nagrody"
                  active={activeCategory === 'award'}
                  onClick={() => setActiveCategory('award')}
                  count={getCategoryCount('award')}
                />
              </motion.div>
              <motion.div variants={staggerItem}>
                <NavItem
                  label="Konkursy"
                  active={activeCategory === 'competition'}
                  onClick={() => setActiveCategory('competition')}
                  count={getCategoryCount('competition')}
                />
              </motion.div>
            </motion.nav>
            ...
            >
              <motion.div className="text-[9rem] font-black leading-none text-foreground/20 select-none">
          ...
          <div className="lg:w-3/5 xl:w-2/3 h-auto lg:h-screen flex flex-col pt-8 lg:pt-36 px-6 lg:px-10 pb-8">
            ...
            <div className="flex-1 pr-4 -mr-4 custom-scrollbar h-auto overflow-visible lg:overflow-y-auto lg:max-h-[calc(100vh-14.5rem)] lg:[mask-image:linear-gradient(to_bottom,black_60%,transparent_100%)] lg:[webkit-mask-image:linear-gradient(to_bottom,black_60%,transparent_100%)]">
              <style jsx>{`
          ...
          <div className="max-w-5xl mx-auto px-6">
            ...
            >
              ...
              <p className="text-sm text-muted-foreground/60 max-w-lg mx-auto leading-relaxed">
                Poznaj kluczowe technologie i wartości napędzające moją drogę badawczą i
                deweloperską.
              </p>
            </motion.div>
