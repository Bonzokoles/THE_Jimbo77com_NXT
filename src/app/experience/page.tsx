...
const highlightContent = {
  education: {
    ...
    description:
      'Każda linia kodu zaczyna się od zrozumienia. Ciągłe samokształcenie i praktyka budują moje podejście do złożonych problemów z myśleniem systemowym.',
  },
  journey: {
    title: 'Tworzenie Doświadczeń',
    highlight: 'Które Mają Znaczenie',
    description:
      'Od pierwszych projektów po budowę platform AI — każdy krok to lekcja innowacji, automatyzacji i przekraczania granic.',
  },
  experience: {
    title: 'Zamieniam Pomysły',
    highlight: 'W Rzeczywistość',
    description:
      'Production-ready projekty, które rozwiązują realne problemy. 30+ AI Workers, 500K+ requestów dziennie, jeden commit na raz.',
  },
};
  ...
  return (
    ...
    >
      <HeroHighlight containerClassName="h-[30rem] rounded-3xl overflow-hidden">
        ...
        >
          {content.title}{' '}
          <Highlight className="text-black dark:text-white">{content.highlight}</Highlight>
        </motion.h2>
        <motion.p
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
  ...
  const tabs: TabItem[] = [
    {
      ...
      label: 'Rozwój',
      description:
        'Ciągły rozwój przez samokształcenie, kursy online i budowanie produkcyjnych platform od zera.',
    },
    {
      id: 'journey',
      label: 'Podróż',
      description:
        'Oś czasu ról, odpowiedzialności i rozwoju zawodowego — od freelance do własnej firmy.',
    },
    {
      id: 'experience',
      label: 'Doświadczenie',
      description:
        'Szczegółowy przegląd doświadczeń z projektami AI, automatyzacją i edge computing.',
    },
  ];
      ...
      <div className="mx-auto w-full max-w-5xl px-8 text-center sm:px-12 mb-12">
        ...
        <div className="-m-1 flex flex-wrap justify-center gap-1 sm:gap-1.5">
          {tabs.map((tab, index) => (
            <button
              key={index}
              className={`m-1.5 inline-flex justify-center items-center gap-2.5 rounded-full px-5 py-2.5 text-sm whitespace-nowrap shadow-sm transition-colors duration-150 focus-visible:ring focus-visible:ring-cyan-300 focus-visible:outline-none sm:px-6 sm:py-3 sm:text-base ${
                activeTab === index
            ...
            >
              <div className="flex flex-col items-center justify-center py-16 text-center space-y-4">
                ...
                <p className="text-muted-foreground max-w-md">
                  Szczegółowy przegląd doświadczenia z wyróżnionymi projektami i osiągnięciami
                  będzie tu wkrótce dostępny.
                </p>
              </div>
